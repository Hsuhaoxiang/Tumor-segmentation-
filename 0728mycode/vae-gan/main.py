...
print("size:(%d,%d,%d)"%(x,y,z))
net_G = Generator(4,classes,104,104,104)
print(net_G)
net_G=net_G.cuda()
...
train(net_G,net_D,optimizerG,optimizerD, train_loader,'./savecheckpoint_104/' , x,y,z,n_epochs = 100 , times = 4,start_epoch = 0 )
